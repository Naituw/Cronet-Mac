...
#define BUILDFLAG_INTERNAL_ENABLE_QUIC_SUPPORT() (0)
#define BUILDFLAG_INTERNAL_ENABLE_SPDY_HTTP2_SUPPORT() (!DISABLED_SPDY_HTTP2)
#define BUILDFLAG_INTERNAL_ENABLE_WEBSOCKETS() (0)
#define BUILDFLAG_INTERNAL_USE_BYTE_CERTS() (0)
